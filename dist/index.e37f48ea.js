...
var _sectionView = require("./views/sectionView");
var _sectionViewDefault = parcelHelpers.interopDefault(_sectionView);
const controlSection = function() {
    const section = window.location.hash.slice(1);
    // Guard Clause
    if (section !== 'landing' && section !== 'submitted' && section !== 'slider' || section === _model.state.curPage) return;
    // 1) Hide current section
    _sectionViewDefault.default.hideSection(_model.state.curPage);
    // 2) Display new section
    _sectionViewDefault.default.displaySection(section);
    // 3) Change current page in the state
    _model.updateCurPage(section);
};
const init = function() {
    _sectionViewDefault.default.addHandlerDisplaySection(controlSection);
};
init();

},{"./model":"Y4A21","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/sectionView":"ebUQX"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state
);
parcelHelpers.export(exports, "updateCurPage", ()=>updateCurPage
);
const state = {
    curPage: 'landing'
};
const updateCurPage = function(curPage) {
...
},{}],"ebUQX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class sectionView {
    ...
    hideSection(section) {
        ...
        _gsapDefault.default.to(section, {
            opacity: 0,
            ease: 'Power2.easeOut',
            duration: _config.ANIMATION_TIME
        });
        setTimeout(function() {
            section.style.display = 'none';
        }, _config.ANIMATION_TIME * 1000);
    }
...
exports.default = new sectionView();

},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../config":"k5Hzs"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ANIMATION_TIME", ()=>ANIMATION_TIME
);
const ANIMATION_TIME = 0.75;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ddCAb","aenu9"], "aenu9", "parcelRequirecc26")
